  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="text-3xl font-extrabold text-on-surface tracking-tight font-display">Create your workspace</h2>
        <p className="mt-2 text-sm text-on-surface-variant">
          Already registered?{' '}
          <Link href="/login" className="font-semibold text-primary hover:text-primary/80 transition font-mono text-xs uppercase tracking-wider">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="glass-panel py-8 px-4 shadow-2xl rounded-2xl sm:px-10 border border-outline/30">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="company" className="block text-sm font-medium text-on-surface font-mono uppercase tracking-wider text-xs">
                Company Name
              </label>
            ...
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-on-surface font-mono uppercase tracking-wider text-xs">
                Your Name
              </label>
              <div className="mt-1.5">
                <input
            ...
            <div>
              ...
              >
                {loading ? (
                  ...
                  <>
                    Register Workspace <ArrowRight size={16} />
                  </>
                )}
              </button>
            </div>
